...
-- Catatan: id produk sekarang integer (generated by default as identity)
-- sesuai migrations/0001_init.sql. Urutan id mengikuti sort_order:
--   1-17  = PRD001..PRD017, 18 = PRD029, 19 = PRD030,
--   20    = PRD018, 21-30 = PRD019..PRD028.
-- =====================================================================
...
values
    ...
    (1, 'PRD001', 'Coklat Batangan 70%', 'chocolate-bar', 35000, 'pcs', null,
    ...
    (2, 'PRD002', 'Coklat Batangan 80%', 'chocolate-bar', 35000, 'pcs', null,
    ...
    (3, 'PRD003', 'Coklat Batangan 100% (Dark Chocolate)', 'chocolate-bar', 45000, 'pcs', null,
    ...
    (4, 'PRD004', 'Coklat Batangan Balado', 'chocolate-bar', 35000, 'pcs', null,
    ...
    (5, 'PRD005', 'Coklat Paralin Pouch', 'praline-snack', 35000, 'pouch', null,
    ...
    (6, 'PRD006', 'Coklat Paralin Kotak', 'praline-snack', 100000, 'box', null,
    ...
    (7, 'PRD007', 'Coklat Paralin Botol Besar', 'praline-snack', 130000, 'botol', null,
    ...
    (8, 'PRD008', 'Coklat Paralin Botol Kecil', 'praline-snack', 130000, 'botol', null,
    ...
    (9, 'PRD009', 'Coklat 3in1 300gr', 'chocolate-drink', 65000, 'pack', '300gr',
    ...
    (10, 'PRD010', 'Coklat 3in1 500gr', 'chocolate-drink', 100000, 'pack', '500gr',
    ...
    (11, 'PRD011', 'Coklat 3in1 1000gr', 'chocolate-drink', 120000, 'pack', '1000gr (1 kg)',
    ...
    (12, 'PRD012', 'Malicho Drink Sachet', 'chocolate-drink', 40000, 'renteng', null,
    ...
    (13, 'PRD013', 'Cocoa Powder 300gr', 'cocoa-ingredients', 125000, 'pack', '300gr',
    ...
    (14, 'PRD014', 'Cocoa Powder 1000gr', 'cocoa-ingredients', 400000, 'pack', '1000gr (1 kg)',
    ...
    (15, 'PRD015', 'Biji Kakao 250gr', 'cocoa-ingredients', 250000, 'pack', '250gr',
    ...
    (16, 'PRD016', 'Cocoa Butter 250gr', 'cocoa-ingredients', 250000, 'pack', '250gr',
    ...
    (17, 'PRD017', 'Cocoa Butter 1000gr', 'cocoa-ingredients', 500000, 'pack', '1000gr (1 kg)',
    ...
    (18, 'PRD029', 'Cocoa Powder 50gr', 'cocoa-ingredients', 25000, 'gram', '50gr',
    ...
    (19, 'PRD030', 'Cocoa Powder 100gr', 'cocoa-ingredients', 45000, 'gram', '100gr',
    ...
    (20, 'PRD018', 'Ball Choco Pouch', 'ball-choco', 15000, 'pouch', null,
    ...
    -- 06 · Rendang (rendang)
    (21, 'PRD019', 'Rendang Coklat Daging 250gr', 'rendang', 95000, 'pack', '250gr',
    ...
    (22, 'PRD020', 'Rendang Daging 100gr (Sachet)', 'rendang', 30000, 'pack', '100gr',
    ...
    (23, 'PRD021', 'Rendang Forkids 200gr', 'rendang', 85000, 'pack', '200gr',
    ...
    (24, 'PRD022', 'Rendang Coklat Paru 250gr', 'rendang', 95000, 'pack', '250gr',
    ...
    (25, 'PRD023', 'Rendang Paru 100gr (Sachet)', 'rendang', 30000, 'pack', '100gr',
    ...
    (26, 'PRD024', 'Rendang Jengkol 250gr', 'rendang', 65000, 'pack', '250gr',
    ...
    (27, 'PRD025', 'Rendang Nangka 250gr', 'rendang', 55000, 'pack', '250gr',
    ...
    (28, 'PRD026', 'Rendang Nangka 100gr (Sachet)', 'rendang', 10000, 'pack', '100gr',
    ...
    (29, 'PRD027', 'Bumbung Rendang 250gr', 'rendang', 45000, 'pcs', '250gr',
    ...
    (30, 'PRD028', 'Bumbung Rendang 100gr', 'rendang', 20000, 'pcs', '100gr',
